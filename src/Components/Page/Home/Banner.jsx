...
function Banner() {
  return (
    <div className='w-full xl:px-28 py-8 bg-grey-300'>
        <div className='py-28 flex flex-col md:flex-row-reverse justify-evenly items-center gap-4 '>
        ...
        <div className='md:w-1/2 '>
          ...
          <button className='md:mx-8 bg-black hover:bg-orange-500 px-6 py-2  text-white font-semibold rounded-sm flex items-center gap-2'>
